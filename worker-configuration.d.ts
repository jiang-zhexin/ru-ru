/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 479d381eb390f91aabd93ad92711ccae)
// Runtime types generated with workerd@1.20260730.1 2026-06-16 nodejs_compat
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
	DEV: string;
	SyncGeoSite: Workflow<Parameters<import("./src/index").SyncGeoSite['run']>[0]['payload']>;
	SyncGeoIP: Workflow<Parameters<import("./src/index").SyncGeoIP['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "DEV">> {}
}
