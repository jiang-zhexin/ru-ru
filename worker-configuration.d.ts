/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8b4c327cbf29cdbabf8dedb817e63899)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRETTY_JSON">> {}
}
